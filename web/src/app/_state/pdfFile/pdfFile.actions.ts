...
export const createPdfFile = createAction('[PdfFile] Create Pdf File' ,props<{ payload: { pdfFileType: string, targetId: string, pdfUrl?: string, file?: FormData } }>());
...
export const updatePdfFile = createAction('[PdfFile] Update Pdf File' ,props<{ payload: { pdfFileType: string, targetId: string, pdfUrl?: string, file?: FormData } }>());
...
export const downloadPdfFileError = createAction('[PdfFile] Download Pdf File Error', props<{ errorMessage: string }>());
