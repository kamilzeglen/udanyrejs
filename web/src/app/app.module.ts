...
const components = [AppComponent, LayoutComponent, NavbarComponent, FooterComponent, ErrorComponent];

const others = [DatepickerCustomHeaderComponent];

const guards = [AuthGuard];

@NgModule({
  declarations: [...components, ...others],
  imports: [
