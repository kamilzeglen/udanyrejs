...
export class InitDB1733920136881 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pdf_file" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "originalName" character varying(255) NOT NULL, "path" character varying(255) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "offerId" uuid NOT NULL, CONSTRAINT "REL_f52285d64ef013ec6b760a4bcc" UNIQUE ("offerId"), CONSTRAINT "PK_755efe31cd4ebf040dc679c3d26" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "image_file" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "originalName" character varying(255) NOT NULL, "path" character varying(255) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "offerId" uuid NOT NULL, CONSTRAINT "REL_c8d9be1e9c16dff4e5c41d4c9e" UNIQUE ("offerId"), CONSTRAINT "PK_a63c149156c13fef954c6f56398" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "offer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "offerUrl" character varying, "syncData" boolean NOT NULL DEFAULT false, "companyId" uuid NOT NULL, "shipId" uuid NOT NULL, "price" numeric NOT NULL, "startDate" TIMESTAMP NOT NULL, "endDate" TIMESTAMP NOT NULL, "imageFileId" uuid, "pdfFileId" uuid, "itinerary" json, "createdById" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "REL_09a60e20a02a56c92e6ed9b171" UNIQUE ("imageFileId"), CONSTRAINT "REL_0c702471989d167d3f17a4d0ae" UNIQUE ("pdfFileId"), CONSTRAINT "PK_57c6ae1abe49201919ef68de900" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "ship" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "companyId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_136d2c1d431c06ed161e6281661" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "offer" ADD CONSTRAINT "FK_0cd06080ca85eae7defcf236e17" FOREIGN KEY ("shipId") REFERENCES "ship"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
